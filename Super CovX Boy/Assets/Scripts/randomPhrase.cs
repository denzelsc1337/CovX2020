...
public class randomPhrase : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string[] tips = new string[] {
          ...
          "No frotes tus manos contra tu cara si has tenido contacto con monedas, barandas o algun material que tenga contacto con otras personas",
          "Usa desinfectantes y al llegar de algun lugar siempre aleja la ropa que llevas puesta de la que no has usado",
          "Si presentas fiebre, tos seca y dificultad para respirar acude a tu centro de salud mas cercano",
